                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            //upload user details
                            FirebaseDatabase.getInstance().getReference("Users").child(usernameinfirebase.getUid()).child("uid").setValue(usernameinfirebase.getUid());
                            FirebaseDatabase.getInstance().getReference("Users").child(usernameinfirebase.getUid()).child("email").setValue(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
